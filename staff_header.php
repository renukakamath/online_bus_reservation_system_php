    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="staff_home.php" class="nav-item nav-link active">Home</a>
               
               
                  <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Views</a>
                    <div class="dropdown-menu bg-light m-0">
                        <a href="staff_viewprofile.php" class="dropdown-item">Profile</a>
                        <a href="staff_viewresrvation.php" class="dropdown-item">View Reservation</a>
